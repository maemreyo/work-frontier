...
describe("EvidenceCollector", () => {
  ...
  it("initializes and captures 40-character commit SHA", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-01", "vitest", "2.1.0")
  ...
  it("accumulates multiple results via addResult", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-02", "vitest", "2.1.0")
  ...
  it("computes SHA-256 hash for artifacts via addArtifact", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-03", "vitest", "2.1.0")
  ...
  it("sets status to pass when exit_code is 0 and all results passed", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-04", "vitest", "2.1.0")
  ...
  it("sets status to fail when any result failed", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-05", "vitest", "2.1.0")
  ...
  it("sets status to fail when exit_code is non-zero", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-06", "vitest", "2.1.0")
  ...
  it("calculates duration_seconds correctly", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-07", "vitest", "2.1.0")
  ...
  it("includes working_directory when provided", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-08", "vitest", "2.1.0")

    const startTime = new Date()
    const endTime = new Date(startTime.getTime() + 1000)
    const record = collector.build("vitest run", 0, startTime, endTime, "/path/to/workdir")

    expect(record.invocation.working_directory).toBe("/path/to/workdir")
  })

  it("omits working_directory when not provided", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-09", "vitest", "2.1.0")
  ...
  it("produces valid EvidenceRecord structure that serializes to JSON", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-10", "vitest", "2.1.0")
  ...
  it("handles empty results array correctly", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-11", "vitest", "2.1.0")
  ...
  it("accumulates multiple artifacts via addArtifact", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-12", "vitest", "2.1.0")
  ...
  it("includes optional detail in addResult", () => {
    const collector = new EvidenceCollector("WF-HAR-TYPESCRIPT-13", "vitest", "2.1.0")
